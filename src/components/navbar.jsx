...
function Navbar() {
  return (
    ...
    <div class="relative flex items-center w-full h-12 rounded-lg  overflow-hidden ">
        ...
        <input
        class="peer h-full w-full outline-none text-sm bg-[#F8F8F8] text-gray-700 pr-2"
        type="text"
        id="search"
        placeholder="Search something.." /> 
    </div>
      </div>
      <button className='max-[600px]:hidden'>Login</button>
      <a href="#" className="flex items-center max-[600px]:hidden justify-center rounded-md bg-[#0C831F] px-3 py-2.5 text-center text-[14px] font-medium text-white ">
      <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
      My Cart</a>
     <button className='h-8 w-8 bg-[#0C831F] text-white hidden max-[600px]:flex rounded-full  items-center justify-center max-[600px]:text-[25px] text-[30px]'>
